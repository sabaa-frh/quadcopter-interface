...
class DroneStatusBlock(QWidget):
    ...
    def initUI(self):
        ...
        extra_layout.addWidget(sat_header, 0, 0, alignment=Qt.AlignmentFlag.AlignCenter)
        extra_layout.addWidget(time_header, 0, 1, alignment=Qt.AlignmentFlag.AlignCenter)
        self.sat_value = QLabel("N/A")
        self.time_value = QLabel("N/A")
        extra_layout.addWidget(self.sat_value, 1, 0, alignment=Qt.AlignmentFlag.AlignCenter)
        extra_layout.addWidget(self.time_value, 1, 1, alignment=Qt.AlignmentFlag.AlignCenter)
    ...
    def update_gps_status(self, connected, lat, lon, alt, fix_type, sat_count, current_time):
        """
        Update the LED color and the GPS data fields.
        """
        # LED: green if connected, red if not
        if connected:
...
class DisplayWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.drone_status = DroneStatusBlock()
